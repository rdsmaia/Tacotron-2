...
def main():
	...
	parser.add_argument('--speaker_id', default=0, help='Defines the speakers ids to use when running standalone Wavenet on a folder of mels. this variable must be a comma-separated list of ids')
